...
package Prime_Server is
   ...
   overriding procedure Finalize (Client : in out Prime_Connection);
   overriding procedure Received
     (Client  : in out Prime_Connection; Data : Stream_Element_Array;
      Pointer : in out Stream_Element_Offset);

   overriding procedure Sent (Client : in out Prime_Connection);
